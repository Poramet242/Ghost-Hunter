...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    [SerializeField] public int _pageCount;
    ...
    [SerializeField] private bool _showPageSelection;
    [SerializeField] private int _previousPageSelectionIndex;
    ...
    //------------------------------------------------------------------------
    public void onClickScreen(int num)
    {
        LerpToPage(num);
    }
    //------------------------------------------------------------------------
